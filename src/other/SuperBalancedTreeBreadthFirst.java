...
public class SuperBalancedTreeBreadthFirst {
    ...
    public static boolean isBalanced(BinaryTreeNode treeRoot) {
        ...
        while (!nodes.isEmpty()) {
            ...
            if (nodeDepthPair.node.left != null) {
                ...
                nodes.addLast(new NodeDepthPair(nodeDepthPair.node.left, depth + 1));
            }
            if (nodeDepthPair.node.right != null) {
                nodes.addLast(new NodeDepthPair(nodeDepthPair.node.right, depth + 1));
            }
        }
    ...
    public static boolean valueExists(BinaryTreeNode treeRoot, int value) {
    ...
    public void fullTreeTest() {
        ...
        final boolean containsValue = valueExists(root, 2);
        assertTrue(result);
